...
![NPM Downloads](https://img.shields.io/npm/dy/react-table-of-content?logo=npm)
![GitHub License](https://img.shields.io/github/license/pecrio/react-table-of-content)
![NPM Version](https://img.shields.io/npm/v/react-table-of-content)
...
- [React table of content](#react-table-of-content)
  ...
  - [API](#api)
    - [Hooks](#hooks)
      - [`useTableOfContent`](#usetableofcontent)
        - [Arguments](#arguments)
    ...
    - [Utility functions](#utility-functions)
      ...
      - [`readTime`](#readtime)
        ...
        - [Usage and example](#usage-and-example-3)
  - [Testing](#testing)
  - [License](#license)
  - [Author](#author)
